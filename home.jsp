...
<c:url value="/j_spring_security_logout" var="logoutUrl" />
	...
	<div class="header">
	<h2 style="margin-left:65px; font-family: Brush script MT, cursive; font-size: 70px; color:  #862d86;text-shadow: 10px 10px 0px #ecc6ec;">Musicaa</h2>
	</div>
	...
	<ul class="nav navbar-nav nav-left">
				<li class="action"><a href="hotDeals"><span
						class="glyphicon glyphicon"> HotDeals</span></a></li>
	...
	<div class="container-fluid text-center">
			<center>
				...
				<h3>
					<font face="TIMES NEW ROMAN" color=#800088>MUSICAL
						INSTRUMENTS</font>
				</h3>
			</center>
...
<footer class="container-fluid text-right">
	...
	<div class="col-sm-12">
	<div class="row">
		<p style="margin-top:15px"><a href="#" style="color:#E0E0E0"> &copycopyright.musicaa.com</a>       <span> | </span>       <span><a href="#" style="color:#E0E0E0"  >follow us</a></span>        <span> | </span>           <span><a href="#" style="color:#E0E0E0">about us</a></span></p>		
		</div>
		</div></div>
		</div>
				</footer>
